...
function writeClientConfigurations() {
    var file = System_1.System.rootDir + cf.CLIENT_CONFIGURATION_OUTPUT;
    if (System_1.System.exists(file)) {
        System_1.System.removeFile(file);
    }
    var clientConfiguration = require('../Configurations/Client').default;
    var startWrap = 'window.cf = (function() {\nvar configs = ';
    var body = JSON.stringify(clientConfiguration, null, 4) + ';\n';
    var makeRegExp = 'for(var key in configs) {\n    if (/_SYNTAX$/.test(key)) {\n        configs[key] = new RegExp(configs[key]);\n    }\n}\n';
    var endWrap = 'return configs;\n})();';
    System_1.System.writeFile(file, startWrap + body + makeRegExp + endWrap);
}
