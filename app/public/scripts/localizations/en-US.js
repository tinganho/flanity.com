;(function() {
  ...
  var localizations = {
    'en-US': {
      ...
      'SIGN_UP->SUCCESSFUL_SIGN_UP_MESSAGE': function(it) {
        var string = '';
        string += 'Sign up successful, loggin you in...';
        return string;
      },
      'SIGN_UP->INVALID_INVITATION_TOKEN_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'Invalid invitation.';
        return string;
      },
      'DEFAULT->UNKNOW_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'Something went wrong.';
        return string;
      },
      'SIGN_UP->USERNAME_ALREADY_TAKEN_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'Username is taken.';
        return string;
      },
      'SIGN_UP->INVALID_EMAIL_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'Invalid email.';
        return string;
      },
      'SIGN_UP->INVALID_PASSWORD_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'Password to short.';
        return string;
      },
      'SIGN_UP->INVALID_USERNAME_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'Invalid username.';
        return string;
      },
      'SIGN_UP->NO_EMAIL_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'No email.';
        return string;
      },
      'SIGN_UP->NO_NAME_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'No name.';
        return string;
      },
      'SIGN_UP->NO_PASSWORD_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'No password.';
        return string;
      },
      'SIGN_UP->NO_USERNAME_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'No username.';
        return string;
      },
      'SIGN_UP->USERNAME_UNIQUE_SUCCESS_MESSAGE': function(it) {
        var string = '';
        string += 'Username is unique.';
        return string;
      },
      'SIGN_UP->EMAIL_ALREADY_TAKEN_ERROR_MESSAGE': function(it) {
        var string = '';
        string += 'Email already taken.';
        return string;
      },
      'IMAGE_CROP->ZOOM_HELP_TEXT': function(it) {
        var string = '';
        string += 'Scroll to zoom';
        return string;
      },
      'DEFAULT->DONE': function(it) {
        var string = '';
        string += 'Done';
        return string;
      },
      'SIGN_UP->INVITE_FRIEND_PLACEHOLDER': function(it) {
        var string = '';
        string += 'Your friend\'s email';
        return string;
      },
      'SIGN_UP->INVITE_FRIEND_PROMPT_TEXT': function(it) {
        var string = '';
        string += 'Flanity is a social network. Inviting a friend or two helps a lot to achieve a meaningful network.';
        return string;
      },
      'SIGN_UP->SUBMIT_BUTTON_TEXT': function(it) {
        var string = '';
        string += 'Join';
        return string;
      },
      'SIGN_UP->USERNAME_PLACEHOLDER': function(it) {
        var string = '';
        string += 'Username';
        return string;
      },
      'SIGN_UP->EMAIL_PLACEHOLDER': function(it) {
        var string = '';
        string += 'Email';
        return string;
      },
      'SIGN_UP->NAME_PLACEHOLDER': function(it) {
        var string = '';
        string += 'Name';
        return string;
      },
      'SIGN_UP->PASSWORD_PLACEHOLDER': function(it) {
        var string = '';
        string += 'Password';
        return string;
      },
      'DEFAULT->LOGIN': function(it) {
        var string = '';
        string += 'Login';
        return string;
      },
      'HERO->SIGNUP_BUTTON': function(it) {
        var string = '';
        string += 'Sign up';
        return string;
      },
      'HERO->DESCRIPTION': function(it) {
        var string = '';
        string += 'Topic based news streaming.';
        return string;
      }
    }
  };
