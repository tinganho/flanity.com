...
declare interface IDOMElement {
    ...
    getWidth(): number;
    getHeight(): number;
    append(element: IDOMElement): IDOMElement;
    prepend(element: IDOMElement): IDOMElement;
    before(element: IDOMElement): IDOMElement;
    after(element: IDOMElement): IDOMElement;
    remove(): void;
    hide(): IDOMElement;
    onClick(listener: EventListener): IDOMElement;
    onDbClick(listener: EventListener): IDOMElement;
    onFocus(listener: EventListener): IDOMElement;
    onBlur(listener: EventListener): IDOMElement;
    onSubmit(listener: EventListener): IDOMElement;
    show(): this;
